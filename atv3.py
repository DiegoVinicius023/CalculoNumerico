...
class Atividade3:
    def ex1():
        ...
        npol = 1
        narred = 4
        minquad = MinimosQuadrados.minimosQuadrados(vt,vlnI,npol,narred)
    ...
    def ex2():
        ...
        npol = 2
        narred = 4
        return MinimosQuadrados.minimosQuadrados(vx,vy,npol,narred)
    ...
    def ex3():
        ...
        return MinimosQuadrados.minimosQuadrados(vf,vc,1)
    ...
    def ex4():
        ...
        pt100 = MinimosQuadrados.minimosQuadrados(vx,vpt100,1)
        alpha = round(pt100[1]/pt100[0],5)
        ntc = MinimosQuadrados.minimosQuadrados(vx,vntc,1)
        beta = "não feito"
        return [alpha, beta]
