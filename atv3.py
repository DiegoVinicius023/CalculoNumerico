...
class Atividade3:
    def ex1():
        ...
        npol = 1
        narred = 4
        minquad = MinimosQuadrados.minimos_quadrados(vt,vlnI,npol,narred)
    ...
    def ex2():
        ...
        npol = 2
        narred = 4
        return MinimosQuadrados.minimos_quadrados(vx,vy,npol,narred)
    ...
    def ex3():
        ...
        return MinimosQuadrados.minimos_quadrados(vf,vc,1)
    ...
    def ex4():
        ...
        pt100 = MinimosQuadrados.minimos_quadrados(vx,vpt100,1)
        alpha = round(pt100[1]/pt100[0],5)
        ntc = MinimosQuadrados.minimos_quadrados(vx,vntc,1)
        beta = "não feito"
        return [alpha, beta]
